...
var upgradeEndscreen = {
    ...
    message: "End screen includes custom titles, call to action, and colors for unlimited video projects.",
...
var upgradeTheme = {
    ...
    message: "Theming includes changing the color of your player as well as adding a custom icon to the top left of your video projects.",
    button: "Upgrade your plan",
    buttonTarget: "settings/plans"
};
